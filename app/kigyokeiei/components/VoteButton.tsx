...
type Props = {
  ...
  handleMyAnswerChange:(num:number,answer:"correct"|"incorrect",change:number)=>void
}
          ...
          onClick={() => {
            ...
            if (!isPosting && (myAnswer === "none" || myAnswer === "incorrect")) {
              ...
              if (myAnswer === "incorrect") {
                // 前回の投票を相殺
                props.handleMyAnswerChange(props.num, "incorrect", -1);
              }
              // 新しい投票を送信
              props.handleMyAnswerChange(props.num, "correct", 1);
              setIsPosting(false);
            }
          }}
        >
